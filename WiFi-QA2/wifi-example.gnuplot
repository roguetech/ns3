...
plot "QA2-throughput.data" with lines title "WiFi Throughput vs. Distance"
...
plot "QA2-delay.data" with lines title "WiFi Delay vs. Distance"
...
plot "QA2-loss.data" with lines title "WiFi PLR vs. Distance"
